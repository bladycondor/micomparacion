...
private String nro_resolucionhcc; 
  ...
  private int nro_memo;
   private Date fecha;  
    ...
    private int nro_designacion;
     ...
     public int getNro_designacion() { return this.nro_designacion; }
  public void setNro_designacion(int nro_designacion) { this.nro_designacion = nro_designacion; }  
  ...
  public int getNro_memo() { return this.nro_memo; }
  public void setNro_memo(int nro_memo) { this.nro_memo = nro_memo; }  
  
  public Date getFecha() { return fecha; }
  public void setFecha(Date fecha) { this.fecha = fecha; }
  
  public String getNro_resolucionhcc() { return this.nro_resolucionhcc; }
  public void setNro_resolucionhcc(String nro_resolucionhcc) { this.nro_resolucionhcc = nro_resolucionhcc; }
  
  public String getNro_resolucionhcf() { return this.nro_resolucionhcf; }
  public void setNro_resolucionhcf(String nro_resolucionhcf) { this.nro_resolucionhcf = nro_resolucionhcf; }
  
  public String getNro_resolucionhcu() { return this.nro_resolucionhcu; }
  public void setNro_resolucionhcu(String nro_resolucionhcu) { this.nro_resolucionhcu = nro_resolucionhcu; }
  ...
  public int getId_materia() { return this.id_materia; }
  ...
  public int getId_fase() { return this.id_fase; }
  public void setId_fase(int id_fase) { this.id_fase = id_fase; }  
  
  public String getFase() { return this.fase; }
  public void setFase(String fase) { this.fase = fase; }  

  public int getId_tipo_evaluacion() { return this.id_tipo_evaluacion; }
  ...
  public double getNota_aprobacion() { return this.nota_aprobacion; }
  public void setNota_aprobacion(double nota_aprobacion) { this.nota_aprobacion = nota_aprobacion; }    

  public int getPonderacion_modelo() { return this.ponderacion_modelo; }
  public void setPonderacion_modelo(int ponderacion_modelo) { this.ponderacion_modelo = ponderacion_modelo; }    
  
  public int getPonderacion_materia() { return this.ponderacion_materia; }
  public void setPonderacion_materia(int ponderacion_materia) { this.ponderacion_materia = ponderacion_materia; }    
  
  public int getHrs_teoricas() { return this.hrs_teoricas; }
  public void setHrs_teoricas(int hrs_teoricas) { this.hrs_teoricas = hrs_teoricas; }    
  
  public int getHrs_practicas() { return this.hrs_practicas; }
...
//  public void setCreditos(float creditos) { this.creditos = creditos; }  
  ...
  public int getId_tipo_materia() { return this.id_tipo_materia; }
  public void setId_tipo_materia(int id_tipo_materia) { this.id_tipo_materia = id_tipo_materia; }    
  
  public int getId_departamento() { return this.id_departamento; }
  ...
  public int getPonderacion() { return this.ponderacion; }
  public void setPonderacion(int ponderacion) { this.ponderacion = ponderacion; }  

  public int getId_tipo_nota() { return this.id_tipo_nota; }
  public void setId_tipo_nota(int id_tipo_nota) { this.id_tipo_nota = id_tipo_nota; }  
  
  public String getTipo_nota() { return this.tipo_nota; }
  public void setTipo_nota(String tipo_nota) { this.tipo_nota = tipo_nota; }      
  
  public int getPeriodo() { return this.periodo;}
  public void setPeriodo(int periodo) { this.periodo = periodo; }    

  public int getGestion() { return this.gestion; }
  public void setGestion(int gestion) { this.gestion = gestion; }
  
  public String getNombres() { return this.nombres; }
  public void setNombres(String nombres) { this.nombres = nombres; }        

  public Date getFec_registro() { return this.fec_registro; }
  public void setFec_registro(Date fec_registro) { this.fec_registro = fec_registro; }        

  public int getUlt_usuario() { return this.ult_usuario; }
  public void setUlt_usuario(int ult_usuario) { this.ult_usuario = ult_usuario; }          
  
  public int getId_modelo_fase() { return this.id_modelo_fase;}
  public void setId_modelo_fase(int id_modelo_fase) { this.id_modelo_fase = id_modelo_fase; }      
  
  public int getPadre() { return this.padre; }
  public void setPadre(int padre) { this.padre = padre; }  


  public int getId_evaluacion() { return this.id_evaluacion;}
  public void setId_evaluacion(int id_evaluacion) { this.id_evaluacion = id_evaluacion; }      

  public List getMateria_ahorro(){ return materia_ahorro;}
  public void setMateria_ahorro(List materia_ahorro){this.materia_ahorro = materia_ahorro;}
  
  public int getId_tipo_grado() { return this.id_tipo_grado;}
  ...
  public int getId_tipo_asignacion() { return id_tipo_asignacion; }
  public void setId_tipo_asignacion(int id_tipo_asignacion) { this.id_tipo_asignacion = id_tipo_asignacion; }
  
  public String getTipo_asignacion() { return tipo_asignacion; }
  public void setTipo_asignacion(String tipo_asignacion) { this.tipo_asignacion = tipo_asignacion; }
  
  public int getId_tipo_docente() { return id_tipo_docente; }
  public void setId_tipo_docente(int id_tipo_docente) { this.id_tipo_docente = id_tipo_docente; }
  
  public String getTipo_docente() { return tipo_docente; }
  public void setTipo_docente(String tipo_docente) { this.tipo_docente = tipo_docente; }
  ...
  public Date getFec_fin2() { return fec_fin2; }
  public void setFec_fin2(Date fec_fin2) { this.fec_fin2 = fec_fin2; }
  
  public List getMaterias(){ return materias; }
  public void setMaterias(List materias){ this.materias = materias; }
  
  public int getTotal_horas() { return this.total_horas; }
  public void setTotal_horas(int total_horas) { this.total_horas = total_horas; }    
