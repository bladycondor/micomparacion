...
public class Funciones implements Serializable {
  ...
  public String parseMoneda(double valor){
    ...
    try{
      ...
      System.out.println("Error al convertir el valor " + valor + ", EL error fué: " + e);
      resultado = "";
    }
  	return resultado;
  }
...
/////////////////////// funciones del aurelio swt
  ...
  public boolean esMoneda(String valor){
    ...
    Number numero = null;
      ...
      System.out.println("Error al verificar la conversión el valor " + valor + " a moneda lo que resultó " + numero + " (" + valor_real + "), EL error fué: " + e);
      resultado = false;
    }
  	return resultado;
  }
  ...
  public double parseMonedaDouble(String valor){
    ...
    try{
      ...
      System.out.println("Error al convertir el valor moneda: " + valor + " a real lo que resultó " + resultado + ", EL error fué: " + e);
      resultado = 0;
    }
  	return resultado;
  }
  ...
  public String parseMoneda(double valor, int n){
    ...
    df.setGroupingSize(3);
      ...
      System.out.println("Error al convertir el valor " + valor + " a moneda con " + n + " decimales, EL error fué: " + e);
      resultado = "";
    }
  	return resultado;
  }
  ...
  try {
    ...
    System.out.println("Error al convertir el valor " + valor + " a un numero real, el error fué: " + e);
	  resultado = 0;
	}
    return resultado;
  }
  ...
  public double redondear(double valor, int n){
    ...
    DecimalFormat df = new DecimalFormat(formato, unusualSymbols);
      ...
      System.out.println("Error al redondear el valor " + valor + "a " + n + " dígitos, EL error fué: " + e);
      resultado = 0;
    }
    return resultado;
  }
  ...
  public String parseDecimal(double valor, int n){
    ...
    try{
      ...
      System.out.println("Error al convertir el valor " + valor + "a " + n + " decimales, EL error fué: " + e);
      resultado = "";
    }
    return resultado;
  }
