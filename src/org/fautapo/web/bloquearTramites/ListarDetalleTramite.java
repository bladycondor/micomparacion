...
public class ListarDetalleTramite implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	if (iResultado == 0) {
	  return new ModelAndView("Aviso", "mensaje", "Este proceso no es de esta área");
	}
	...
	datosTramite2 = (Tramites) this.mi.getBuscarTramiteUbicacionOrganica(datosTramite);
	  ...
	  return new ModelAndView("Error", "mensaje", "Este proceso no se puede bloquear ya que está anulado");
	}
        
	if ("C".equals(datosTramite2.getId_estado())) {
	  return new ModelAndView("Error", "mensaje", "Este proceso no se puede bloquear ya que está concluido");
	}

	if ("P".equals(datosTramite2.getId_estado())) {
	  return new ModelAndView("Error", "mensaje", "Este proceso no se puede bloquear ya que está en tránsito");
	}
