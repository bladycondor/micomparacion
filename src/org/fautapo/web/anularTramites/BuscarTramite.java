...
public class BuscarTramite implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	return new ModelAndView("Error", "mensaje", "Este proceso no se puede anular ya que está concluido");
      }

      if ("P".equals(datosTramite2.getId_estado())) {
	return new ModelAndView("Error", "mensaje", "Este proceso no se puede anular ya que está en tránsito");
      }
	  
      if ("B".equals(datosTramite2.getId_estado())) {
	return new ModelAndView("Error", "mensaje", "Este proceso no se puede anular ya que está bloqueado");
      }
