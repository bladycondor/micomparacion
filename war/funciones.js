...
function validar(obj, tipo) {
  ...
  if (obj.value == "") {
    ...
    case 'A' :
      for (i=0; i < cad.length; i++) {
        if (!((cad[i] == ' ')||((cad[i] >= 'a')&&(cad[i] <= 'z'))||((cad[i]  >= 'A')&&(cad[i] <= 'Z'))||(cad[i]=='.')||(cad[i]=='ñ')||(cad[i]=='Ñ')
	      ||(cad[i]=='á')||(cad[i]=='Á')||(cad[i]=='é')||(cad[i]=='É')||(cad[i]=='í')||(cad[i]=='Í')||(cad[i]=='ó')||(cad[i]=='Ó')
	      ||(cad[i]=='ú')||(cad[i]=='Ú') )) {
    ...
    case 'A9':
      for (i=0; i<cad.length; i++) {
        if (!((cad[i] == '%')||(cad[i] == ' ')||((cad[i]>='0')&&(cad[i]<='9'))||((cad[i]>='a')&&(cad[i]<='z'))||((cad[i]>='A')&&(cad[i]<='Z'))||(cad[i]=='ñ')||(cad[i]=='Ñ')
	      ||(cad[i]=='á')||(cad[i]=='Á')||(cad[i]=='é')||(cad[i]=='É')||(cad[i]=='í')||(cad[i]=='Í')||(cad[i]=='ó')||(cad[i]=='Ó')||(cad[i]=='ú')||(cad[i]=='Ú') )) {
